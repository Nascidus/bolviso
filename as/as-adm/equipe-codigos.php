...
<div class="alinha6">CÓDIGOS EQUIPE</div>
</div>
		
<div id="ferramentas-painel-padding">
	
<div id="codigos_php"><strong>Nome do Banco de Dados:</strong> equipe</div>	
		
<div id="codigos_php"><strong>Pasta de Imagem:</strong> img2/equipe</div>	

<div id="codigos_php">
<strong>Nome: </strong>$nome<BR><BR>
<strong>Descrição:</strong> $desc<BR><BR>
<strong>Função:</strong> $funcao<BR><BR>
